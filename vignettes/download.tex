...
can load the data into R in one step. In the example below, we are
downloading the standard ISRaD data object and storing it as a variable
called \texttt{mydata}.

It accepts two parameters, directory and extra. \texttt{directory} =
where you want to downlaod the data object.\\
