...
ISRaD.extra.geospatial.soil <- function(database, geodata_directory) {
  ...
  local_folder <- paste(geodata_directory)

  setwd(geodata_directory)
  ...
  if(!file.exists(savefile_USDA_250m)) {
    ...
    print('Downloading USDA classification raster...')
  }
  else {
    print('USDA raster already downloaded...')
  }
  ...
  if(!file.exists(savefile_ORC_0cm)) {
    ...
    print('Downloading ORC 0cm raster...')
  }
  else {
    print('ORC 0cm raster already downloaded...')
  }
  ...
  if(!file.exists(savefile_ORC_5cm)) {
    ...
    print('Downloading ORC 5cm raster...')
  }
  else {
    print('ORC 5cm raster already downloaded...')
  }
  ...
  if(!file.exists(savefile_ORC_15cm)) {
    ...
    print('Downloading ORC 15cm raster...')
  }
  else {
    print('ORC 15cm raster already downloaded...')
  }
  ...
  if(!file.exists(savefile_ORC_30cm)) {
    ...
    print('Downloading ORC 30cm raster...')
  }
  else {
    print('ORC 30cm raster already downloaded...')
  }
  ...
  if(!file.exists(savefile_ORC_60cm)) {
    ...
    print('Downloading ORC 60cm raster...')
  }
  else {
    print('ORC 60cm raster already downloaded...')
  }
  ...
  if(!file.exists(savefile_ORC_100cm)) {
    ...
    print('Downloading ORC 100cm raster...')
  }
  else {
    print('ORC 100cm raster already downloaded...')
  }
