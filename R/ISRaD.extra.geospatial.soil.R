...
#'
#' @description Function to download and extract soil data from ISRIC spatial data products. WARNING: downloads (if necessary) large data files (>15 GB total)
#' @param database ISRaD dataset object.
#' @param geodata_soil_directory directory where geospatial soil datasets are found, or to which the files can be downloaded.
