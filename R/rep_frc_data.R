...
rep_frc_data<-function(database=NULL){
  ...
  #   left_join(.data, database$layer) %>% #Join to layer data
  #   left_join(.data, database$profile) %>% #Join to profile data
  #   left_join(.data, database$site) %>% #Join to site data
  #   left_join(.data, database$metadata)) #Join to metadata
