...
#' @param geodata_soil_directory geodata_clim_directory directories where geospatial data are found
...
ISRaD.extra<-function(database, geodata_clim_directory, geodata_soil_directory){
  ...
  database<-ISRaD.extra.geospatial.climate(database, geodata_directory=geodata_clim_directory)
  database<-ISRaD.extra.geospatial.soil(database, geodata_directory=geodata_soil_directory)
